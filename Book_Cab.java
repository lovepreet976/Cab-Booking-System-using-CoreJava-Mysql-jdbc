...
f=new JFrame ("Book Intracity Cab"); 
...
id1 =new JLabel("Book Intracity Cabs");
...
ch1.addMouseListener(new MouseAdapter()
        ...
        String q2="select destination from intracity_driver where source='"+source+"'";
...
ch2.addMouseListener(new MouseAdapter()
        ...
        String q3="select * from intracity_driver where source='"+source+"'and destination='"+destination+"'";
        ...
        try
      {
          ...
          String q4= "insert into intracitycab values('"+bid+"', '"+username+"', '"+dname+"', '"+car+"' , '"+source+"', '"+destination+"', '"+price+"')";
          int aa =obj1.stm.executeUpdate(q4);
          if (aa==1){
          JOptionPane.showMessageDialog(null, "Cab Booked Successfully");
          f.setVisible(false);new HomePage().setVisible(true);
