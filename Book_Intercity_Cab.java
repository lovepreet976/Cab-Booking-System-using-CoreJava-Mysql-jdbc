...
f=new JFrame ("Book Intercity Cab"); 
...
ImageIcon ic= new ImageIcon (ClassLoader.getSystemResource("CabBooking/Images/abc.png")); 
Image img=ic.getImage().getScaledInstance (1550, 800, Image.SCALE_DEFAULT);
ImageIcon ic1=new ImageIcon(img);
id.setIcon(ic1);

id1 =new JLabel("Book Intercity Cabs");
...
ch1.addMouseListener(new MouseAdapter()
        ...
        String q2="select destination from intercity_driver where source='"+source+"'";
...
ch2.addMouseListener(new MouseAdapter()
        ...
        String q3="select * from intercity_driver where source='"+source+"'and destination='"+destination+"'";
        ResultSet rest3=obj.stm.executeQuery(q3);
        while (rest3.next()){
        t6.setText(rest3.getString("driver"));
        t7.setText(rest3.getString("car"));
        t8.setText(rest3.getString("source"));
        t9.setText(rest3.getString("destination"));
        t10.setText(rest3.getString("Price"));
        ch4.add(rest3.getString("type"));
        }
        rest3.close();
        }
        catch(Exception bb)
        ...
        try
      {
          ...
          String q4= "insert into intercitycab values('"+bid+"', '"+username+"', '"+dname+"', '"+car+"' , '"+source+"', '"+destination+"', '"+price+"','"+type+"')";
          int aa =obj1.stm.executeUpdate(q4);
          if (aa==1){
          JOptionPane.showMessageDialog(null, " intercity Cab Booked Successfully");
          f.setVisible(false);
